...
contract LowVolTest is Test, CLTestUtils {
    ...
    function setUp() public {
        vm.createSelectFork(vm.rpcUrl("sepolia"), 5268655); // 2 Feb 2024
    ...
    function testLowVolLowAmt() public {
        // Arrange
        uint128 amtIn = uint128(100 ether);
        ...
        assertEq(amtOut, 99504781641550797611);
    }

    function testLowVolMidAmt() public {
        // Arrange
        uint128 amtIn = uint128(900 ether);
        ...
        // Assert
        assertEq(fee, 100); // 0.01%
        assertEq(amtOut, 862076076964339029353);
    }
    ...
    function testLowVolHighAmt() public {
        ...
        // Assert
        assertEq(fee, 100); // 0.01%
        assertEq(amtOut, 198048499498523126634);
    }
}
